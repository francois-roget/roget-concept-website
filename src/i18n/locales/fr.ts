...
export const fr: Translations = {
	...
	sideProjects: {
		...
		description: "Des projets personnels nés d'une vraie envie — des apps iOS aux outils web pour formateurs.",
		paniersBadge: 'App iOS',
		paniersTagline: 'Liste de courses intelligente pour iPhone, iPad, Mac & Apple Watch',
		discoverPaniers: 'Découvrir Paniers',
		voxroomBadge: 'Web App',
		voxroomTagline: 'Sondages en direct pour vos sessions de formation',
		discoverVoxroom: 'Découvrir VoxRoom',
	},
	voxroom: {
		eyebrow: 'Side Project · Web App',
		title: 'VoxRoom',
		tagline: 'Des sondages en direct simples et instantanés pour formateurs',
		description: "Conçu pour rendre les sessions de formation vraiment interactives. Créez des questions, lancez-les en un clic, et affichez les résultats en temps réel — les participants rejoignent avec un code à 4 caractères, sans compte requis.",
		features: {
			live: 'QCM et nuages de mots lancés en un clic depuis votre tableau de bord',
			noReg: 'Les participants rejoignent avec un simple code à 4 caractères — sans compte',
			results: 'Graphiques et nuages de mots apparaissent instantanément sur le projecteur',
			dashboard: 'Tableau de bord dédié pour créer et gérer vos sessions de formation',
		},
		cta: 'Essayer VoxRoom',
		free: 'Gratuit',
	},
