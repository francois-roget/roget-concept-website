export const en = {
	...
	hero: {
		...
		bioContinue:
			'. Based in Belgium, I help teams deliver robust, maintainable, and scalable web applications.',
		bioSub:
			'Pragmatic, no-nonsense solutions that move your projects forward — available remotely worldwide.',
	...
	sideProjects: {
		...
		description: 'Personal projects built to scratch real itches — from iOS apps to web tools for trainers.',
		paniersBadge: 'iOS App',
		paniersTagline: 'Smart shopping list for iPhone, iPad, Mac & Apple Watch',
		discoverPaniers: 'Discover Paniers',
		voxroomBadge: 'Web App',
		voxroomTagline: 'Live polling for your training sessions',
		discoverVoxroom: 'Discover VoxRoom',
	},
	voxroom: {
		eyebrow: 'Side Project · Web App',
		title: 'VoxRoom',
		tagline: 'Simple and instant live polling for trainers',
		description: 'Built to make training sessions genuinely interactive. Create questions, launch them in one click, and display results in real time — participants join with a 4-character code, no account needed.',
		features: {
			live: 'MCQ and word clouds launched in one click from your control panel',
			noReg: 'Participants join with a simple 4-character code — no account required',
			results: 'Charts and word clouds appear instantly on the projector screen',
			dashboard: 'Dedicated trainer dashboard to create sessions and manage questions',
		},
		cta: 'Try VoxRoom',
		free: 'Free to use',
	},
