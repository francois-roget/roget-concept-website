...
export default async function PaniersPage({ params }: Props) {
						...
						<div className="flex flex-col gap-3.5 mb-8">
							{features.map(({ icon, label }) => (
								<div key={label} className="flex items-start gap-3">
									<span className="text-secondary text-base mt-px shrink-0">{icon}</span>
									<span className="text-[14px] text-white/70 leading-snug">{label}</span>
								</div>
							))}
						</div>
					...
					<div className="flex justify-center lg:justify-end">
						<div className="relative">
							...
							<div className="relative w-[300px] rounded-[3.5rem] bg-gray-900 border-[12px] border-gray-800 shadow-[0_40px_100px_rgba(0,0,0,0.6)] overflow-hidden">
								...
								<div
									className="bg-[#c8efc0] flex items-center justify-center"
